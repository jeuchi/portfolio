...
export default function Home() {
  return (
    <div className="bg-base-300 min-w-fit">
      <div className="navbar bg-base-100 fixed z-10">
        <div className="flex-1">
          <a href="#about" className="btn btn-ghost sm:text-lg">
            Jeremy Euchi
          </a>
        </div>
          ...
          <div className="hero-content flex-col lg:flex-row">
            ...
            <div className="sm:pl-12">
              ...
              <p className="py-6 px-10 sm:px-0">
                ...
                California, Los Angeles. I have a Master of Science in
                Electrical and Computer Engineering and a Bachelor of Science in
                Computer Science from the University of California, Santa Cruz.
                I have experience in firmware development and software
                engineering, and I am passionate about technology and
                innovation.
              </p>
              <div className="flex flex-row gap-2 px-10 sm:px-0">
                <a
                  href="https://drive.google.com/file/d/1IWitA4s4XyK2jMesi5q7ylZqqb-vRNwc/view?usp=sharing"
                  target="_blank"
            ...
            <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
              <li>
                ...
                <div className="timeline-start mb-10 md:text-start">
                  ...
                  I worked on developing firmware in C for the new RES
                  720&#8482; receiver used in Global Navigation Satellite
                  Systems, utilizing Airoha's chip and API. My responsibilities
                  included implementing protocols like TSIP and NMEA for
                  transmission over serial ports and managing Trimble's VTS
                  legacy software in C++ to query and process information from
                  the satellite receiver. I logged packets to CSV files and
                  graphed satellites in use, signal levels, and other pertinent
                  data. Additionally, I developed a method to send 1Hz timing
                  signals after a pulse-per-second signal had been generated in
                  the hardware.
                </div>
              ...
              <li>
                ...
                <div className="timeline-start mb-10 md:text-start">
                  ...
                  Building on my experience at Trimble, I continued working on
                  firmware development for the RES 720&#8482; receiver and
                  managed the Skydel GNSS simulator to conduct comprehensive
                  tests on the units. I assisted the SQA team in testing the
                  Thunderbolt® PTP Grandmaster Clock GM200, utilizing JIRA
                  Zephyr software to manage test cases and performing tests on
                  both CLI and GUI components. Serving as the lead developer on
                  a project to modernize Trimble's legacy software, I leveraged
                  Qt 6 C++, QML, and JavaScript to develop an application called
                  VTS2, available on Windows, macOS, and various Linux
                  distributions. Currently in pre-alpha testing by engineers,
                  the application will utilize tools like Azure for continuous
                  integration testing and deployment. This GUI tool facilitates
                  easy configuration, analysis, logging, and playback of GNSS
                  receiver data over serial communication. Additionally, as the
                  lead developer for the WebUI of the new GM330 device, I
                  modernized the GUI from the GM200 by employing modern web
                  frameworks like React and integrating Sysrepo for the
                  NodeJS/C++ backend.
                </div>
                <hr className="bg-secondary" />
              </li>
          ...
          <div className="hero-content flex flex-col">
            ...
            <div role="tablist" className="tabs tabs-lifted tabs-lg">
              ...
              >
                ...
                <p className="py-6">
                  We proposed a solution to extend state-of-the-art AI's that
                  currently play the game of Khet (chess with lasers). Using
                  Alpha-Beta pruning and our heuristics, we have an optimal
                  solver that beats other AI's for end-game scenarios and
                  guarantee an optimal solution exists for the board state.
                </p>
              </div>
